      ...
      <header className="border-b-3 border-border bg-bg-secondary">
        <div className="container-default py-16">
          ...
          <div className="max-w-3xl">
            <div className="inline-block px-3 py-1 bg-accent text-text-inverse font-mono text-xs uppercase tracking-widest mb-6 animate-fade-up stagger-1">
              Base de connaissances
            </div>
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl text-text-primary leading-[1.1] mb-6 animate-fade-up stagger-2">
              Concepts Fondamentaux
            </h1>
            <p className="font-body text-xl text-text-muted leading-relaxed animate-fade-up stagger-3">
        ...
        <div className="grid grid-cols-3 gap-4 mb-16">
          {(Object.entries(CONCEPT_LEVELS) as [ConceptLevel, typeof CONCEPT_LEVELS[ConceptLevel]][]).map(
            ([level, info]) => (
              <div
                key={level}
                className="border-3 border-border bg-bg-secondary p-6 text-center"
              >
