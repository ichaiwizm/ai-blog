...
TypeScript est un langage de programmation développé par Microsoft. Il constitue un sur-ensemble de <Term>JavaScript</Term>, ajoutant un système de types statiques optionnel. Le code TypeScript est compilé en <Term>JavaScript</Term> standard pour être exécuté.
...
TypeScript peut être adopté progressivement. Les fichiers <Term>JavaScript</Term> existants fonctionnent sans modification. L'ajout de types s'effectue fichier par fichier selon les besoins.
